...
public class SkullCreator {
    ...
    public static final String TEXTURE_URL = "https://textures.minecraft.net/texture/";
    ...
    public static ItemStack itemFromTexture(String value) {
        return itemFromUrl(TEXTURE_URL + value);
    }
